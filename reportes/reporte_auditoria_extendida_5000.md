...
- Total de muestras auditadas: 5000.

- freihand: 5000 muestras (100.0%).
...
- Brillo medio: 118.031.
- Baja iluminacion: 0.93%.
- Sombras fuertes: 8.0%.
- Posible contraluz (proxy): 0.13%.
- Temperatura de color: fria=0.23%, calida=94.33%.

## 4) Complejidad de Fondo (Proxy)
- Densidad de bordes media: 0.0332.
- Escenas con fondo complejo (edge density alta): 0.0%.
- Varianza de Laplaciano media: 309.51.
...
- Graficos exportados en: graficos/auditoria_extendida_5000
